...
namespace Manage_KPI_or_OKR_System.Migrations
{
    ...
    [Migration("20260815044445_AddAccountAiHistory")]
    partial class AddAccountAiHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manage_KPI_or_OKR_System.Models.AI.AiHistoryEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("AccessScopeHash")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("TenantId", "SessionId", "Sequence")
                        .IsUnique();

                    b.HasIndex("TenantId", "SessionId", "OperationId", "EntryKind")
                        .IsUnique();

                    b.ToTable("AiHistoryEntries", t =>
                        {
                            t.HasCheckConstraint("CK_AiHistoryEntries_EntryKind", "[EntryKind] IN ('Input','Output','Warning','Decision','LegacyMetadata')");

                            t.HasCheckConstraint("CK_AiHistoryEntries_Sequence", "[Sequence] > 0 AND [PayloadSchemaVersion] > 0");

                            t.HasCheckConstraint("CK_AiHistoryEntries_Status", "[Status] IN ('Pending','Completed','Abstained','AwaitingReview','Applied','Rejected','Conflict','Failed','ContentDeleted')");
                        });
                });

            modelBuilder.Entity("Manage_KPI_or_OKR_System.Models.AI.AiHistorySession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset?>("ContentDeletedAtUtc")
                        .HasColumnType("datetimeoffset");

                    b.Property<int?>("ContentDeletedBySystemUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "OwnerSystemUserId", "ContentDeletedAtUtc", "UpdatedAtUtc");

                    b.ToTable("AiHistorySessions", t =>
                        {
                            t.HasCheckConstraint("CK_AiHistorySessions_Status", "[Status] IN ('Pending','Completed','Abstained','AwaitingReview','Applied','Rejected','Conflict','Failed','ContentDeleted')");

                            t.HasCheckConstraint("CK_AiHistorySessions_Title", "[Title] IS NULL OR LEN(LTRIM(RTRIM([Title]))) BETWEEN 1 AND 200");
                        });
                });
            ...
            modelBuilder.Entity("Manage_KPI_or_OKR_System.Models.AI.AiHistoryEntry", b =>
                {
                    ...
                    b.HasOne("Manage_KPI_or_OKR_System.Models.AI.AiHistorySession", "Session")
                        .WithMany("Entries")
