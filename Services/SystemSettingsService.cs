...
namespace Manage_KPI_or_OKR_System.Services
{
    ...
    public class SystemSettingsService : ISystemSettingsService
    {
        public static readonly IReadOnlyList<SystemSettingDefinition> Definitions = new List<SystemSettingDefinition>
        {
            ...
            new(SystemSettingCodes.PrimaryColor, "#1a73e8", "Màu chủ đạo của nút, icon và điểm nhấn.", "Branding", "color"),
            new(SystemSettingCodes.PrimaryDarkColor, "#1557b0", "Màu chủ đạo đậm cho hover/heading.", "Branding", "color"),
            new(SystemSettingCodes.SidebarColor, "#0d2137", "Màu đầu gradient sidebar.", "Branding", "color"),
            new(SystemSettingCodes.SidebarGradientEnd, "#163659", "Màu cuối gradient sidebar.", "Branding", "color"),
            new(SystemSettingCodes.SidebarTextColor, "#ffffff", "Màu chữ trên sidebar.", "Branding", "color"),
            new(SystemSettingCodes.BodyBackgroundColor, "#f5f8fc", "Màu nền tổng thể.", "Branding", "color"),
