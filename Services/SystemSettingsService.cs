...
namespace Manage_KPI_or_OKR_System.Services
{
    ...
    public class SystemSettingsService : ISystemSettingsService
    {
        ...
        {
            new(SystemSettingCodes.ProductName, "NextGen KPI/OKR System", "Tên sản phẩm hiển thị ở title, SEO và email.", "Branding"),
            new(SystemSettingCodes.ShortName, "NextGen System", "Tên ngắn hiển thị trên sidebar.", "Branding"),
            new(SystemSettingCodes.CompanyName, "NextGen", "Tên doanh nghiệp/đơn vị sở hữu hệ thống.", "Branding"),
            new(SystemSettingCodes.Tagline, "Performance & OKR System", "Slogan ngắn dưới logo sidebar.", "Branding"),
            new(SystemSettingCodes.LoginTitle, "Đăng nhập NextGen", "Tiêu đề chính ở màn hình đăng nhập.", "Branding"),
            ...
            new(SystemSettingCodes.FooterText, "© {year} NextGen - KPI & OKR Management System. All rights reserved.", "Nội dung footer. Dùng {year} để tự thay năm hiện tại.", "Branding", "textarea"),
            new(SystemSettingCodes.AiAssistantName, "NextGen AI Assistant", "Tên trợ lý AI trong widget và prompt.", "Branding"),
            ...
            new(SystemSettingCodes.SeoKeywords, "KPI, OKR, quản lý hiệu suất, NextGen, AI Business, quản trị doanh nghiệp", "Từ khoá SEO mặc định.", "Branding"),
            new(SystemSettingCodes.Author, "NextGen", "Author/meta mặc định.", "Branding"),
            new(SystemSettingCodes.PublicBaseUrl, "https://nextgen-kpi.com", "Base URL public dùng cho canonical/OG URL.", "Branding"),
