...
Fit score được server tính theo 35% khớp mục tiêu, 25% kết quả lịch sử cùng nhóm nguồn, 20% assignment/phòng ban, 10% workload/deadline và 10% chất lượng bằng chứng. Đây vẫn không phải đánh giá kỹ năng hay công suất thực tế của nhân sự; thành phần lịch sử bị chấm 0 khi thiếu mẫu và tổng điểm bị ẩn nếu độ phủ bằng chứng dưới 60%. Goal Planning chỉ trả `OutcomeHistorySummary` gồm số task đã hoàn tất, tổng số task và mô tả nguồn; contract và UI không phát phần trăm probability/likelihood trước khi có mô hình riêng vượt đủ cổng dữ liệu và calibration.
