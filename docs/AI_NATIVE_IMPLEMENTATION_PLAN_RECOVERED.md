...
- MinerU chạy trong GPU service riêng, private network, nhận job bất đồng bộ. Tệp PDF/image/DOCX/PPTX/XLSX được quét loại/kích thước/malware, parse thành Markdown/JSON có page/section/table metadata; pin phiên bản image và hoàn tất rà soát license từ [MinerU chính thức](https://github.com/opendatalab/MinerU).
