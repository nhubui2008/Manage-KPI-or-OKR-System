...
namespace Manage_KPI_or_OKR_System.Data
{
    public class MiniERPDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasIndex(e => e.SystemUserId); // Cho phép null
            ...
            // KHÔNG DÙNG VÒNG LẶP NỮA - GHI RÕ TỪNG DÒNG
            modelBuilder.Entity<Role>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<SystemUser>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<MissionVision>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<OKR>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<KPI>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<Product>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<Invoice>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<InventoryReceipt>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<DeliveryNote>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            //modelBuilder.Entity<Department>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            //modelBuilder.Entity<Employee>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<Customer>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<SalesOrder>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<PackingSlip>().HasOne<Employee>().WithMany().HasForeignKey(e => e.CreatedById).OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity<Role_Permission>().HasOne<Role>().WithMany().HasForeignKey(rp => rp.RoleId);
            modelBuilder.Entity<Role_Permission>().HasOne<Permission>().WithMany().HasForeignKey(rp => rp.PermissionId);
            ...
            modelBuilder.Entity<OKRKeyResult>().HasOne<OKR>().WithMany().HasForeignKey(okr => okr.OKRId);
            modelBuilder.Entity<OKR_Mission_Mapping>().HasOne<OKR>().WithMany().HasForeignKey(omm => omm.OKRId);
            modelBuilder.Entity<OKR_Mission_Mapping>().HasOne<MissionVision>().WithMany().HasForeignKey(omm => omm.MissionId);
            ...
            modelBuilder.Entity<KPIDetail>().HasOne<KPI>().WithMany().HasForeignKey(kd => kd.KPIId);
            modelBuilder.Entity<KPI_Department_Assignment>().HasOne<KPI>().WithMany().HasForeignKey(kda => kda.KPIId);
            modelBuilder.Entity<KPI_Department_Assignment>().HasOne<Department>().WithMany().HasForeignKey(kda => kda.DepartmentId);
            modelBuilder.Entity<KPI_Employee_Assignment>().HasOne<KPI>().WithMany().HasForeignKey(kea => kea.KPIId);
            modelBuilder.Entity<KPI_Employee_Assignment>().HasOne<Employee>().WithMany().HasForeignKey(kea => kea.EmployeeId);
            ...
            modelBuilder.Entity<CheckInDetail>().HasOne<KPICheckIn>().WithMany().HasForeignKey(cd => cd.CheckInId);
            modelBuilder.Entity<CheckInHistoryLog>().HasOne<KPICheckIn>().WithMany().HasForeignKey(cl => cl.CheckInId);
            ...
            modelBuilder.Entity<ProductDetail>().HasOne<Product>().WithMany().HasForeignKey(pd => pd.ProductId);
            ...
            modelBuilder.Entity<InventoryReceiptDetail>().HasOne<InventoryReceipt>().WithMany().HasForeignKey(ird => ird.ReceiptId);
            ...
            modelBuilder.Entity<SalesOrderDetail>().HasOne<SalesOrder>().WithMany().HasForeignKey(sod => sod.OrderId);
            ...
            modelBuilder.Entity<ShippingTracking>().HasOne<DeliveryNote>().WithMany().HasForeignKey(st => st.DeliveryNoteId);
            ...
            modelBuilder.Entity<ShippingPriceList>().HasOne<ShippingPartner>().WithMany().HasForeignKey(spl => spl.PartnerId);
        }
    }
}